...
#define block_doubles_per_mol		14
...
class DS {
	...
	private:
		...
		int32_t InitCuda();
		void FreeCuda();
		void ref_caller_worker(double **in, double **out, int32_t i_part, int32_t i_super_cycle, int32_t order_in, int32_t order_out, int32_t iworker, int32_t nworker, cudaStream_t *stream, int32_t gridSize, int32_t blockSize, int32_t myID);
		void b_caller_worker(double **in, double **out, int32_t i_part, int32_t i_super_cycle, int32_t order_in, int32_t order_out, int32_t iworker, int32_t nworker, cudaStream_t *stream, int32_t gridSize, int32_t blockSize, int32_t myID);
